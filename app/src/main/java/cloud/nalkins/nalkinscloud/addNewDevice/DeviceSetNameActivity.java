...
public class DeviceSetNameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView deviceType = (TextView) findViewById(R.id.device_type_value);
        deviceType.setText(DeviceAddNewActivity.getDeviceType());

        // Configure the device name text field
        final TextInputLayout deviceNameWrapper = (TextInputLayout) findViewById(R.id.device_nameWrapper);
