...
public class GetWifiCredentialsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextInputLayout wifiPassWrapper = findViewById(R.id.device_nameWrapper);
        //Set error hints when validation fail
        wifiPassWrapper.setHint("Set wifi Password");

        //Set next button
        Button nextButton = findViewById(R.id.wifiNextButton);
        ...
        nextButton.setOnClickListener((View v) -> {
            if (selectedSSID == null) {
                ...
                // Save the password
                if (wifiPassWrapper.getEditText() != null)
    ...
    public void initiateScannedList() {
        ...
        listView = findViewById(R.id.wifiScanResultList);
